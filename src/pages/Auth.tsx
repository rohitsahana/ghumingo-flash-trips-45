  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: error.message || "Google authentication is not configured. Please use email/password login for now.",
        variant: "destructive",
      });
    } finally {
      setLoading(false);
        ...
        <Card className="w-full">
          ...
          <CardContent className="space-y-4">
            ...
            <p className="text-xs text-gray-500 text-center mt-2">
              Note: Google login requires configuration in Supabase dashboard
            </p>
